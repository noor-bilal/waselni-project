            ...
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right">
                        <a  href="{{url('admin/bus/get')}}"
                           class="btn btn-info round dropdown-menu-right box-shadow-2 px-2">
                                    ...
                                    <div class="card-body card-dashboard">
                                        <table class="table table-striped table-bordered dataex-html5-export">
                                            ...
                                            <tr>
                                                ...
                                                <th>{{__('lang.number_of_seats')}}</th>
                                                <th>{{__('lang.bus_number')}}</th>
                                                <th>{{__('lang.trip_price')}}</th>
                                                <th>{{__('lang.point')}}</th>
                                            ...
                                            @if(count($buses) > 0)
                                                @foreach($buses as $bus)
                                                    <tr>
                                                        ...
                                                        <td>{{$bus->name_ar}}</td>
                                                        <td>{{$bus->name_en}}</td>
{{--                                                        <td>{{direction() == 'ar' ? $bus->start_point_area->name_ar : $bus->start_point_area->name_en}}</td>--}}
{{--                                                        <td>{{direction() == 'ar' ? $bus->end_point_area->name_ar : $bus->end_point_area->name_en}}</td>--}}
                                                        <td>{{$bus->number_of_seats}}</td>
                                                        <td>{{$bus->bus_number}}</td>
                                                        <td>{{$bus->trip_price}}</td>
                                                        <td>{{$bus->point}}</td>
                                                        <td>{{date('Y-m-d',strtotime($bus->created_at))}}</td>
                                                        <td>
                                                            <a href="{{url('admin/bus/get/'.$bus->id)}}"
                                                               class="btn btn-success btn-sm"><i class="la la-edit"></i>
                                                                {{__('lang.edit')}}</a>
                                                            <a href="{{url('admin/bus/delete/'.$bus->id)}}"
                                                               type="button" class="btn btn-danger btn-sm"><i
                                                                    class="la la-trash-o"></i>{{__('lang.delete')}}</a>

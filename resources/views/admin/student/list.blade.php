            ...
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right">
                        ...
                        <a href="{{url('admin/student/get')}}" class="btn btn-info round dropdown-menu-right box-shadow-2 px-2" >
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table class="table table-striped table-bordered dataex-html5-export">
                                            ...
                                            <tr>
                                                <th>#</th>
                                                <th>{{__('lang.finish_time')}}</th>
                                                <th>{{__('lang.student_count')}}</th>
                                                @if(admin()->user()->type=='admin')
                                            ...
                                            @if(count($students) > 0)
                                                @foreach($students as $student)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{url('admin/student/get/'.$student->id)}}" class="btn btn-success btn-sm"><i class="la la-edit"></i>
                                                                {{__('lang.edit')}}</a>
                                                            <a href="{{url('admin/student/delete/'.$student->id)}}" type="button" class="btn btn-danger btn-sm"><i class="la la-trash-o"></i>{{__('lang.delete')}}</a>
                                                        </td>
                                                            @endif
                                                    </tr>
                                                @endforeach

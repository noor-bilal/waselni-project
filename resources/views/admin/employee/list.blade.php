            ...
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right">
                        <a href="{{url('admin/employee/get')}}" class="btn btn-info round dropdown-menu-right box-shadow-2 px-2" >
                                            ...
                                            @if(count($employees) > 0)
                                                @foreach($employees as $employee)
                                                    <tr>
                                                        ...
                                                        <td>{{direction() =='ar' ? $employee->bus->name_ar : $employee->bus->name_en}}</td>
                                                        <td>{{direction() =='ar' ? $employee->bus->name_ar : $employee->bus->bus_number}}</td>
                                                        <td>{{date('Y-m-d',strtotime($employee->created_at))}}</td>

                                                        <td>
                                                            <a href="{{url('admin/employee/get/'.$employee->id)}}" class="btn btn-success btn-sm"><i class="la la-edit"></i>
                                                                {{__('lang.edit')}}</a>
                                                            <a href="{{url('admin/employee/delete/'.$employee->id)}}" type="button" class="btn btn-danger btn-sm"><i class="la la-trash-o"></i>{{__('lang.delete')}}</a>

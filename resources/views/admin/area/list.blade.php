            ...
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right">
                        <a href="{{url('admin/area/get')}}" class="btn btn-info round dropdown-menu-right box-shadow-2 px-2" >
                                            ...
                                            @if(count($areas) > 0)
                                                @foreach($areas as $area)
                                                    <tr>
                                                        ...
                                                        <td>{{$area->name_en}}</td>
                                                        <td>
                                                            <a href="{{url('admin/area/get/'.$area->id)}}" class="btn btn-success btn-sm"><i class="la la-edit"></i>
                                                                {{__('lang.edit')}}</a>
                                                            <a href="{{url('admin/area/delete/'.$area->id)}}" type="button" class="btn btn-danger btn-sm"><i class="la la-trash-o"></i>{{__('lang.delete')}}</a>
